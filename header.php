        ...
        <nav id = "header" class="navbar fixed-top navbar-expand-lg p-0" style = "background-color: #800035;" >
            <div class="container-fluid">
                <a id = "RenataSalazarLogo" class="navbar-brand p-0 m-1" href="index.php" aria-current="page">
                    <img src="Assets\img\LogoWhiteTrasparent.png" width="150" height="150" alt="Renata Salazar Logo ">
                </a>
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav mr-auto mb-2 mb-lg-0">
                        <li id = "AboutMeLink" class="nav-item">
                            <a class="nav-link" href="aboutMe.php">About Me</a>
                        </li>
                        <li id = "GalleryLink" class="nav-item">
                            <a class="nav-link" href="gallery.php">Gallery</a>
                        </li>
                        <li id = "PricingLink" class="nav-item">
                            <a class="nav-link" href="pricing.php">Pricing</a>
                        </li>
                        <li id = "ContactMeLink" class="nav-item">
